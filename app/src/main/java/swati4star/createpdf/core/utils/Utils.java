...
public class Utils {
    ...
    public static void startMarket(Activity activity) {
        Uri uri = Uri.parse(String.format("market://details?id=%s", getAppProcessName(activity)));
        if (isIntentSafe(activity, uri))    //  设备已安装应用市场
        {
        ...
        {
            Toast.makeText(activity, "无法打开应用市场", Toast.LENGTH_SHORT).show();
        }
    }
